...
function sendOTP() {
        $(".phError").html("").hide();
        var baseUrl = "5vq68z.api.infobip.com"
        var authorization = "App 93a62b8380b7fe3d0712279ebf37a9e4-a04a6e11-c829-42c6-a4db-54d2264a2ba0"
        var number = $("#mob_num").val();
        if (number.length == 10 && number != null) {
            var settings = {
                ...
                "data": JSON.stringify({
                    "messages": [{
                        ...
                        "from": "InfoSMS",
                        "text": `Hello there! - Here's OTP for Quick Mechanist. Please don't share the OTP - ${otp}`
                    }]
                }),
            };
